import{a as e,t}from"./index-DcO7zkYV.js";import{t as n}from"./page-79Zon-AD.js";e();var r=`<main>\r
    <section class="hero" id="home">\r
      <div class="wrap hero-grid">\r
        <div>\r
          <span class="stamp">2026–27 官方迎新資料已同步</span>\r
          <h1>Urban Spatial Science MSc</h1>\r
      ...
      <div class="wrap stats" aria-label="課程摘要">\r
        <div class="stat"><b>180</b><span>總學分（MSc）</span></div>\r
        <div class="stat"><b>45</b><span>三門必修授課模組學分</span></div>\r
        <div class="stat"><b>75</b><span>選修學分</span></div>\r
        <div class="stat"><b>60</b><span>Dissertation 學分</span></div>\r
      </div>\r
      <div class="wrap index-panel" id="index">\r
        ...
        <ul class="index-list">\r
          <li><a href="#structure">01．學分與全年結構</a></li>\r
          <li><a href="term1.html">02．Term 1 課程</a></li>\r
          <li><a href="term2.html">03．Term 2 課程與選修</a></li>\r
          <li><a href="#welcome">04．Welcome Week</a></li>\r
          <li><a href="#sources">05．資料來源</a></li>\r
        </ul>\r
      </div>\r
    </section>\r
\r
    <section id="structure">\r
      <div class="wrap">\r
        <div class="section-head">\r
          <div><div class="section-kicker">01 / Course map</div><h2>一年怎麼走？</h2></div>\r
          <div><p class="muted">Full-time 的官方骨架</p><a class="back-home" href="#home">↑ 回到首頁</a></div>\r
        </div>\r
        <div class="timeline">\r
          <article class="term" data-term="01">\r
            <span class="term-label">Term 1 · 打底</span>\r
            <h3>城市、空間、數量方法</h3>\r
            ...
            <ul>\r
              <li>CASA0001 Urban Systems Theory</li>\r
              <li>CASA0005 GIS and Science</li>\r
              <li>CASA0007 Quantitative Methods</li>\r
              <li>CASA0013 Foundations of Spatial Data Science</li>\r
            </ul>\r
            <p><a class="back-home" href="term1.html">查看 Term 1 四門課程 →</a></p>\r
          </article>\r
          <article class="term" data-term="02">\r
            <span class="term-label">Term 2 · 深入</span>\r
            <h3>從 pathway 建立專長組合</h3>\r
            ...
            <ul>\r
              <li>選一個主題方向作為選課參考</li>\r
              <li>從 CASA 模組庫或其他 UCL department 補足選修</li>\r
              <li>部分課程有先修或程式背景要求</li>\r
            </ul>\r
          </article>\r
          <article class="term" data-term="03">\r
            <span class="term-label">Term 3 · 研究</span>\r
            <h3>把問題做成 dissertation</h3>\r
...
\r
    <section id="term1">\r
      <div class="wrap">\r
        <div class="section-head">\r
          <div><div class="section-kicker">02 / Selected modules</div><h2>Term 1：四門課先看這裡</h2></div>\r
          <a class="back-home" href="#home">↑ 回到首頁</a>\r
        </div>\r
...
\r
    <section id="term2">\r
      <div class="wrap">\r
        <div class="section-head">\r
          <div><div class="section-kicker">03 / Term 2 choices</div><h2>Term 2：研究與主題選修</h2></div>\r
          <a class="back-home" href="#home">↑ 回到首頁</a>\r
        </div>\r
...
\r
    <section id="welcome">\r
      <div class="wrap">\r
        <div class="section-head">\r
          <div><div class="section-kicker">04 / Welcome 2026–27</div><h2>開學前與 Welcome Week</h2></div>\r
...
\r
    <section id="sources">\r
      <div class="wrap">\r
        <div class="section-head">\r
          <div><div class="section-kicker">05 / Source notes</div><h2>資料來源與閱讀提醒</h2></div>\r
          <a class="back-home" href="#home">↑ 回到首頁</a>\r
        </div>\r
        <div class="source-list">\r
          ...
          <div class="source"><b>UCL official course page</b><a href="https://www.ucl.ac.uk/prospective-students/graduate/taught-degrees/urban-spatial-science-msc" target="_blank">Urban Spatial Science MSc · 2026/27</a><br><span class="small-note">必修、pathway、optional / elective、study modes 與 180 credits 的主要來源。</span></div>\r
          <div class="source"><b>UCL Module Catalogue</b><a href="https://www.ucl.ac.uk/module-catalogue/" target="_blank">Module Catalogue · 2026/27</a><br><span class="small-note">模組內容、學分、先修背景、教學方式與評量方式。</span></div>\r
        </div>\r
        <div class="callout"><strong>重要：</strong>UCL 明確提醒 module list 是 indicative，模組內容與 availability 可能因年度而變動。這一頁是研究用整理，不取代 UCL 的正式 module selection 或 programme team 的確認。</div>\r
      </div>\r
    </section>\r
  </main>`,i=`\r
    :root {\r
